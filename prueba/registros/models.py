...
class Alumnos(models.Model): #Defines la estructura de nuestra tabla
    matricula = models.CharField(max_length=12, verbose_name="Matricula")#Texto corto
    nombre = models.TextField()#Texto largo
    carrera = models.TextField()
    turno = models.CharField(max_length=10)
    imagen = models.ImageField(null=True,upload_to="Fotos",verbose_name="Fotografía")
    creacion = models.DateTimeField(auto_now_add=True)#Fecha y tiempo
    ...
    class Meta:
        ...
        ordering = ["-creacion"]
        #el menos indica que se ordenaran del más reciente al más abajo

    def __str__(self):
        return self.nombre
        #indica que se mostrara nombre como valor en la tabla
